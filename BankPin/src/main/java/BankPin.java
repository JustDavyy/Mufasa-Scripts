...
public class BankPin extends AbstractScript {
    ...
    @Override
    public void poll() {
        logger.log("Starting the poll method for BankPin.");
        condition.sleep(2000);

        // Main logic
        logger.log("Executing the main logic for BankPin.");
        condition.sleep(5000);
        String bankloc = "Yanille_bank";
