...
public class CourseSetup {
    ...
    private static void setupCourses() {
        ...
        List<Obstacle> gnomeObstacles = List.of(
                new Obstacle("Obstacle 1",
        ...
        COURSE_OBSTACLES.put(Course.GNOME, gnomeObstacles);

        // AL_KHARID course setup
        ...
        List<Obstacle> alkharidObstacles = List.of(
                new Obstacle("Obstacle 1",
                ...
                new Obstacle("Obstacle 4",
                        ...
                        new Rectangle(477, 259, 16, 16), new Rectangle(790, 308, 4, 11),
        ...
        COURSE_OBSTACLES.put(Course.AL_KHARID, alkharidObstacles);

        // VARROCK course setup
        ...
        List<Obstacle> varrockObstacles = List.of(
                new Obstacle("Obstacle 1",
        ...
        COURSE_OBSTACLES.put(Course.VARROCK, varrockObstacles);

        // CANIFIS course setup
        ...
        List<Obstacle> canifisObstacles = List.of(
                new Obstacle("Obstacle 1",
        ...
        COURSE_OBSTACLES.put(Course.CANIFIS, canifisObstacles);

        // FALADOR course setup
        ...
        List<Obstacle> faladorObstacles = List.of(
                new Obstacle("Obstacle 1",
                ...
                new Obstacle("Obstacle 12",
                        new Area(new Tile(12045, 13065, 3), new Tile(12069, 13083, 3)),
        ...
        COURSE_OBSTACLES.put(Course.FALADOR, faladorObstacles);

        // RELLEKKA course setup
        ...
        List<Obstacle> rellekkaObstacles = List.of(
                new Obstacle("Obstacle 1",
        ...
        List<Obstacle> ardyObstacles = List.of(
                new Obstacle("Obstacle 1",
        ...
        COURSE_OBSTACLES.put(Course.ARDOUGNE, ardyObstacles);

        // DRAYNOR course setup
        ...
        List<Obstacle> draynorObstacles = List.of(
                new Obstacle("Obstacle 1",
        ...
        COURSE_OBSTACLES.put(Course.DRAYNOR, draynorObstacles);

        // POLLNIVNEACH course setup
        ...
        COURSE_OBSTACLES.put(Course.POLLNIVNEACH, pollyObstacles);
        ...
        COURSE_OBSTACLES.put(Course.SEERS, seersObstacles);

        // BASIC_COLOSSAL_WYRM course setup
        List<Obstacle> basicColossalWyrmObstacles = List.of(
                new Obstacle("Obstacle 1",
        ...
        COURSE_OBSTACLES.put(Course.BASIC_COLOSSAL_WYRM, basicColossalWyrmObstacles);

        // ADVANCED_COLOSSAL_WYRM course setup
        List<Obstacle> advancedColossalWyrmObstacles = List.of(
                new Obstacle("Obstacle 1",
                        new Area(new Tile(6554, 11453, 0), new Tile(6618, 11502, 0)),
                        new Tile(6603, 11473, 0), new Tile(6611, 11473, 1),
                        new Rectangle(467, 252, 6, 10), new Rectangle(609, 275, 12, 6),
        ...
        COURSE_OBSTACLES.put(Course.ADVANCED_COLOSSAL_WYRM, advancedColossalWyrmObstacles);

    }

    public static List<Obstacle> getObstaclesForCourse(Course course) {
        return COURSE_OBSTACLES.getOrDefault(course, Collections.emptyList());
    }
}
