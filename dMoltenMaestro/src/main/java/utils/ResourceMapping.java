...
public enum ResourceMapping {
    ...
    // Amulets
    OPAL_AMULET(ItemList.OPAL_1609, ItemList.SILVER_BAR_2355, ItemList.OPAL_AMULET__U__21099),
    JADE_AMULET(ItemList.JADE_1611, ItemList.SILVER_BAR_2355, ItemList.JADE_AMULET__U__21102),
    TOPAZ_AMULET(ItemList.RED_TOPAZ_1613, ItemList.SILVER_BAR_2355, ItemList.TOPAZ_AMULET__U__21105),
    SAPPHIRE_AMULET(ItemList.SAPPHIRE_1607, ItemList.GOLD_BAR_2357, ItemList.SAPPHIRE_AMULET__U__1675),
    EMERALD_AMULET(ItemList.EMERALD_1605, ItemList.GOLD_BAR_2357, ItemList.EMERALD_AMULET__U__1677),
    RUBY_AMULET(ItemList.RUBY_1603, ItemList.GOLD_BAR_2357, ItemList.RUBY_AMULET__U__1679),
    DIAMOND_AMULET(ItemList.DIAMOND_1601, ItemList.GOLD_BAR_2357, ItemList.DIAMOND_AMULET__U__1681),
    DRAGONSTONE_AMULET(ItemList.DRAGONSTONE_1615, ItemList.GOLD_BAR_2357, ItemList.DRAGONSTONE_AMULET__U__1683),
    ONYX_AMULET(ItemList.ONYX_6573, ItemList.GOLD_BAR_2357, ItemList.ONYX_AMULET__U__6579),
    ZENYTE_AMULET(ItemList.ZENYTE_19493, ItemList.GOLD_BAR_2357, ItemList.ZENYTE_AMULET__U__19501),
