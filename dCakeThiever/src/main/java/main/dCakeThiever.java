...
public class dCakeThiever extends AbstractScript {
    ...
    public static  Rectangle stallTapWindow = new Rectangle(382, 262, 18, 24);
    ...
    public static int pollsSinceLastDrop = 0;
    ...
    private void initialSetup() {
        ...
        Logger.debugLog(String.valueOf(currentLocation));

        // Check if we are within the script area, otherwise stop the script.

        if (Player.isTileWithinArea(currentLocation, scriptArea)) {
