        ...
        switch (position) {
            case 1:
                if (isValidRect(locationInfo.getClickLocation1())) {
                    ...
                    Condition.wait(() -> !Client.isAnyColorInRect(veinColors.getActiveColor(), locationInfo.getCheckLocation1(), 5), 100, 30);
            ...
            case 2:
                if (isValidRect(locationInfo.getClickLocation2())) {
                    ...
                    Condition.wait(() -> !Client.isAnyColorInRect(veinColors.getActiveColor(), locationInfo.getCheckLocation2(), 5), 100, 30);
            ...
            case 3:
                if (isValidRect(locationInfo.getClickLocation3())) {
                    ...
                    Condition.wait(() -> !Client.isAnyColorInRect(veinColors.getActiveColor(), locationInfo.getCheckLocation3(), 5), 100, 30);
